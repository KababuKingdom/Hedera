const { Client, FileCreateTransaction, ContractExecuteTransaction, ContractCallQuery, Hbar, ContractCreateTransaction, ContractFunctionParameters } = require("@hashgraph/sdk");
...
async function helloWorld() {
 ...
 // Part 3 - Deploy the smart contracit
 ...
 const contractExecTx = await new ContractExecuteTransaction()
  .setContractId(newContractId)
  .setGas(100000)
  .setFunction("set_message", new ContractFunctionParameters().addString("Mutua_Solomon"));
